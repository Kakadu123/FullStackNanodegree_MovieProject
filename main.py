...
trai = media.Movie("Trainspotting ",
                   "Renton, deeply immersed in the Edinburgh drug \
                   scene, tries to clean up and get out, despite the \
...
swee = media.Movie("Sweet and Lowdown",
                   "In the 1930s, fictional jazz guitarist \
                   Emmet Ray idolizes Django Reinhardt, faces \
                   gangsters and falls in love with a mute.",
...
vick = media.Movie("Vicky Cristina Barcelona",
                   "Two girlfriends on a summer holiday in Spain \
                   become enamored with the same painter, unaware \
                   that his ex-wife, with whom he has a tempestuous \
...
amad = media.Movie("Amadeus",
                   "The incredible story of Wolfgang Amadeus \
                   Mozart, told by his peer and secret rival Antonio \
